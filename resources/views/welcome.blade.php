                    ...
                    <div class="flex items-center space-x-2">
                        @guest
                            ...
                            <a href="{{ route('register') }}"
                                class="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition">Daftar</a>
                        @endguest
                        @auth
                            {{ Auth::user()->name }} |
                        ...
                        <!-- If logged in (uncomment when auth is ready) -->
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <a href="#"
                    ...
                    <div class="absolute top-0 right-0 w-20 h-20 bg-white opacity-10 rounded-full -mr-10 -mt-10">
                    </div>
                ...
                <a href="#"
                    ...
                    <h3 class="text-lg font-semibold">Self Development</h3>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">Toko buku online terpercaya dengan ribuan koleksi buku berkualitas.
                    </p>
                </div>
                <div>
